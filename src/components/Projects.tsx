      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {projects.map((project, index) => (
            <div 
              key={index}
              className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group animate-fade-in border border-gray-100 dark:border-gray-700"
            ...
            >
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.techStack.map((tech, techIndex) => (
                      <span 
                        key={techIndex}
                        className="px-3 py-1 bg-portfolio-primary/10 text-portfolio-primary text-xs font-medium rounded-full"
                      >
                        {tech}
                      </span>
                    ))}
              ...
              <div className="mt-auto">
                <a
                  ...
                  className="inline-flex items-center justify-center w-full bg-portfolio-gradient hover:opacity-90 text-white px-4 py-2 rounded-full transition-all duration-300 hover:scale-105 text-sm font-medium"
                >
                  View Project
                </a>
              </div>
