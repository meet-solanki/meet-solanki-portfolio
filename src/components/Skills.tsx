    ...
    <section id="skills" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Programming languages & technologies</p>
                </div>
              </div>
                ...
                {technicalSkills.map((skill, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-portfolio-primary font-semibold bg-portfolio-primary/10 px-2 py-1 rounded-full text-sm">
                        {skill.level}%
                      </span>
                    </div>
                    ...
                    <div className="relative">
                      <Progress 
                        value={skill.level} 
                        className="h-3 bg-gray-200 group-hover:scale-105 transition-transform duration-300"
                      />
                      <div 
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Personal & professional abilities</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                {softSkills.map((skill, index) => (
                  <div 
                    key={index} 
                    className="bg-gray-50 rounded-2xl p-6 hover:bg-portfolio-primary/5 hover:shadow-md hover:scale-105 transition-all duration-300 group cursor-pointer animate-fade-in"
                    style={{ animationDelay: `${index * 0.15}s` }}
                  >
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 bg-portfolio-primary/10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-portfolio-primary/20 group-hover:scale-110 transition-all duration-300">
                        <span className="text-xl">{skill.icon}</span>
                      </div>
                      <div className="flex-1">
                        <h4 className="font-semibold text-gray-800 mb-2 group-hover:text-portfolio-primary transition-colors">
                          {skill.name}
                        </h4>
        ...
        <div className="mt-16 text-center animate-fade-in">
          <div className="bg-white rounded-2xl p-8 shadow-lg inline-block hover:shadow-xl transition-all duration-300">
            <div className="flex items-center justify-center gap-8 flex-wrap">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-600 text-sm">Core Skills</div>
              </div>
              <div className="w-px h-12 bg-gray-200 hidden sm:block"></div>
              <div className="text-center">
                <div className="text-3xl font-bold text-portfolio-primary mb-1">2026</div>
                <div className="text-gray-600 text-sm">Graduate</div>
              </div>
            </div>
          </div>
        </div>
